...
Este libro ha sido escrito en \href{http://rmarkdown.rstudio.com}{R-Markdown} empleando el paquete \href{https://bookdown.org/yihui/bookdown/}{\texttt{bookdown}} y está disponible en el repositorio Github: \href{https://github.com/rubenfcasal/notasr}{rubenfcasal/notasr}.
Se puede acceder a la versión en línea a través del siguiente enlace:

\url{https://rubenfcasal.github.io/notasr}.

donde puede descargarse en formato \href{https://rubenfcasal.github.io/notasr/Notas_R.pdf}{pdf}.
...
Mi recomendación es emplear nombres de archivos y carpetas en minúscula (o con la primera letra en mayúsculas) y sin espacios (por ejemplo empleando \texttt{\_} para separar palabras o iniciales).
Los nombres deberían ser lo más descriptivos posibles (en el sentido de evitar confusión).
Pueden incluirse descripciones más completas en el código, en ficheros de texto (e.g.~\emph{Descripción\_archivos.txt}), o incluso en hojas de cálculo.
...
Para más detalles ver la ayuda de \texttt{?Startup}
...
Finalmente, cuando tengo una primera versión del código (que puedo ir previsualizando; en RStudio basta con pulsar \emph{Ctrl + Shift + K}, o el botón correspondiente en la barra superior, o seleccionar \emph{File \textgreater{} Knit Compile Report\ldots{}}), lo transformo a formato \emph{.Rmd} con un comando de la forma:
...
Para establecer la ruta a archivos o directorios \textbf{se recomienda emplear rutas relativas} (usando \emph{../} para acceder a la carpeta anterior; \emph{./} sería el directorio actual de trabajo).
Por ejemplo:
...
\NormalTok{rmarkdown}\SpecialCharTok{::}\FunctionTok{render}\NormalTok{(}\StringTok{"informe.Rmd"}\NormalTok{, }
                  ...
                  \CommentTok{\# params = list(fecha\_txt = fecha\_txt),}
...
Se puede configurar RStudio para emplear Git (ver \href{https://happygitwithr.com/index.html}{Happy Git and GitHub for the useR} y \href{https://r-pkgs.org/software-development-practices.html\#sec-sw-dev-practices-git-github}{Git and GitHub}), sin embargo yo prefiero emplear \href{https://desktop.github.com/}{GitHub Desktop}.
...
En muchas ocasiones, para modificar los nombres de las variables o los niveles de un factor, suelo recurrir a la función \href{https://rdrr.io/r/base/dput.html}{\texttt{dput()}} para escribirlos en modo texto (e.g.~\texttt{dput(tolower(names(data)))}) y posteriormente modificarlos a mano.
...
Concretamente se añade a la ruta de búsqueda un entorno que contiene el conjunto de objetos exportables del paquete (definido en el denominado \emph{namespace} del paquete).
...
Se puede instalar versiones específicas de un paquete con \href{https://remotes.r-lib.org/reference/install_version.html}{\texttt{install\_version()}}:
...
Para asegurarse que el código de un proyecto se puede ejecutar a lo largo del tiempo se puede emplear el paquete \href{https://rstudio.github.io/renv/}{\texttt{renv}} (se puede configurar automáticamente al crear un proyecto de RStudio).
...
Para más detalles ver \href{https://docs.docker.com/get-started/overview/}{Docker overview} y {[}The Rocker Project{]}\url{https://rocker-project.org/}).
...
Por ejemplo, podemos reproducir el proceso de introducir un comando en la consola con las funciones \texttt{eval()} y \texttt{parse()}:
...
\begin{itemize}
\item
  \href{https://adv-r.hadley.nz/s3.html}{S3}: Es un sistema muy simple, las clases no tienen una definición formal. Es el empleado en el paquete \texttt{base} de R y en la mayoría de paquetes que usan OOP.
...
\item
  \href{https://adv-r.hadley.nz/s4.html}{S4} (\textbf{no lo recomiendo}): Está implementado en el paquete \texttt{methods} (uno de los \emph{paquetes base}) de R.
  Descrito inicialmente en:
...
\tightlist
\item
  \href{https://ggplot2.tidyverse.org}{ggplot2}: visualización de datos.
\item
  \href{https://dplyr.tidyverse.org}{dplyr}: manipulación de datos.
\item
  \href{https://tidyr.tidyverse.org}{tidyr}: reorganización (limpieza) de datos.
\item
  \href{https://readr.tidyverse.org}{readr}: importación de datos.
\item
  \href{https://tibble.tidyverse.org}{tibble}: tablas de datos (modificación de \texttt{data.frame}).
\item
  \href{https://purrr.tidyverse.org}{purrr}: programación funcional.
\item
  \href{https://github.com/tidyverse/stringr}{stringr}: manipulación de cadenas de texto.
\item
  \href{https://github.com/tidyverse/forcats}{forcats}: manipulación de factores.
\item
  \href{https://github.com/tidyverse/lubridate}{lubridate}: manipulación de fechas y horas.
\end{itemize}
...
\textbf{\emph{Repositorio}}: \href{https://github.com/rubenfcasal/notasr}{rubenfcasal/notasr}
...
\href{https://rubenfcasal.github.io/bookdown_intro/rmarkdown.html}{\textbf{\emph{Introducción a RMarkdown}}}.
