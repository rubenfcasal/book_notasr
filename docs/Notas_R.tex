...
Para instalar paquetes adicionales se puede emplear \texttt{install.packages()} (actualmente, 2023-03-29, están disponibles 19325 en \href{https://cran.r-project.org/web/packages/available_packages_by_date.html}{CRAN}, incluso para interactuar con ChatGPT como \href{https://michelnivard.github.io/gptstudio}{\texttt{gptstudio}}).
Por ejemplo:
...
Antes de ponerse a programar, sobre todo si puede terminar siendo un código complejo, la recomendación es hacer una búsqueda por si ya está implementado (o hay algo que podemos tomar como base, es lo bueno de GNU!): en la descripción de los paquetes en \href{https://cran.r-project.org/web/packages/available_packages_by_date.html}{CRAN}, en los buscadores especializados (\href{https://rdrr.io/}{rdrr.io}, \href{https://www.rdocumentation.org/}{RDocumentation} o \href{http://rseek.org/}{RSeek}), en foros de programación (\href{http://stackoverflow.com/questions/tagged/r}{StackOverflow}, \href{https://es.stackoverflow.com/questions/tagged/r}{es.StackOverflow}, \href{https://stats.stackexchange.com}{Cross Validated}), en listas de correo (\href{https://stat.ethz.ch/mailman/listinfo}{r-project.org}, \href{https://r-help-es.r-project.narkive.com}{r-help-es}) o directamente en \href{https://www.google.com/search?q=r-project}{Google} (añadiendo \emph{r-project} o similar en la búsqueda)).
...
En muchas ocasiones se emplea como punto de partida una función ya implementada en algún paquete de R.
...
\CommentTok{\# NOTA: Cuidado con la codificación latin1 (no declarada) en R \textgreater{}= 4.2 }
