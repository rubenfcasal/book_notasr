...
En muchas ocasiones, para modificar los nombres de las variables o los niveles de un factor, suelo recurrir a la función `r cite_fun(dput)` para escribirlos en modo texto (e.g. `dput(tolower(names(data)))`) y posteriormente modificarlos a mano.
